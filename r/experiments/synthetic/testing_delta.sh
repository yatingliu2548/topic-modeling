...
result_file="testing_delta_anchor_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}"
echo "result file is ${result_file}"
cd $SCRATCH/$USER/topic-modeling/
Rscript r/experiments/synthetic/testing_offset.R $SLURM_ARRAY_TASK_ID $result_file $1 $2 $3 $4 # 5 topic
